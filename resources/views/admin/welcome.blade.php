...
<body class="font-sans antialiased text-capitalize dark:bg-black dark:text-white/50">
                        ...
                        <nav class="flex justify-end flex-1 -mx-3">
                            @auth
                                @php
                                    ...
                                    $hasAccess = in_array($userRole, ['super_admin', 'team_lead']);
                                @endphp
                                ...
                                @else
                                    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                                        <div class="relative flex flex-col items-center justify-center min-h-screen">
                                            ...
                                            <a href="{{ url('/') }}" class="text-blue-500 underline">Go back to
                                                home</a>
                                        </div>
                                    </div>
                                @endif
